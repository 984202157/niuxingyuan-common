...
public class StringUtil {
	...
	public static String randomChineseStrings(int length){
		String str="";
...
public static  boolean isNumber(String src) {	
	...
	public static String getPlaceholderValue(String src, String regex){
		String str="";
		String[] s=src.split("-");
		int i=s[s.length-1].lastIndexOf(".");
		str=s[s.length-1].substring(0,i);
